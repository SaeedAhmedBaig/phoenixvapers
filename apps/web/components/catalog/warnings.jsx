export function WarningsBlock({ warnings = [] }) {
  ...
  return (
    <aside className="border-warning/30 bg-warning/5 rounded-none border p-4 text-sm" role="note">
...
export function ApiDownNotice({ className = "" }) {
  return (
    <div className={`border-warning/30 bg-warning/5 rounded-none border px-4 py-3 text-sm ${className}`} role="status">
