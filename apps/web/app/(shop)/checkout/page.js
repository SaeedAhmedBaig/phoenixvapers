          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <Button asChild className=""><Link href="/verify">Verify my age</Link></Button>
                <Button asChild variant="outline" className=""><Link href="/basket">Back to basket</Link></Button>
              </div>
            </div>
          </div>
        </div>
