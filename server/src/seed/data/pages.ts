export const pageSeeds = [
    ...
    sections: [
      {
        ...
        cards: [
          { title: "TPD 10ml", text: "Freebase nicotine bottles for familiar throat hit and simple everyday use.", meta: "0mg to 20mg options" },
          { title: "Shortfills", text: "50ml and 100ml bottles with room for VG or PG nicotine shots.", meta: "Ideal for bigger clouds" },
          { title: "Nic Salts", text: "Smoother high-strength nicotine for pod systems and MTL devices.", meta: "Great for switchers" },
          { title: "Nicotine Shots", text: "VG and PG shots to tune shortfills toward DTL or MTL vaping.", meta: "Mix to your style" },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        cards: [
          { title: "Starter Kits", text: "Complete beginner-friendly kits for simple setup and reliable MTL use.", meta: "Best for new vapers" },
          { title: "Pod Kits", text: "Compact rechargeable systems suited to nic salts and daily carry.", meta: "Smooth and portable" },
          { title: "Sub Ohm Kits", text: "Higher-powered kits for DTL airflow, shortfills, and larger vapour production.", meta: "Advanced flavour" },
          { title: "Mods Only", text: "Standalone devices for customers who already know their tanks and batteries.", meta: "Experienced users" },
        ],
      },
      {
        title: "Key Brands",
  ...
  },
  {
    ...
    stats: [
      ...
      ["0.14ohm", "ultra-low sub-ohm"],
      ["2.0ohm", "tight MTL range"],
    ],
    sections: [
      {
        title: "Resistance Guide",
        cards: [
          { title: "0.14ohm - 0.2ohm", text: "Ultra-low resistance for cloud production and direct-to-lung setups.", meta: "DTL" },
          { title: "0.3ohm - 0.6ohm", text: "Balanced flavour and vapour for many modern tanks and kits.", meta: "Balanced" },
          { title: "0.8ohm - 1.2ohm", text: "Smooth draw for pod kits, nic salts, and mouth-to-lung vaping.", meta: "MTL" },
          { title: "1.4ohm - 2.0ohm", text: "Tighter MTL draw and CBD-friendly vaping styles.", meta: "High resistance" },
        ],
      },
    ],
  },
  {
    ...
    description: "Give CBD shoppers a calm, education-led category page covering strength, format, and stocked brands.",
    cta: "Ask Support",
    ctaHref: "/contact",
    stats: [
    ...
    sections: [
      {
        title: "CBD Formats",
        cards: [
          { title: "Tinctures", text: "Oral CBD drops across multiple strengths for measured daily use.", meta: "8 products" },
          { title: "Edibles", text: "Ingestible CBD options for customers who prefer non-vape formats.", meta: "2 products" },
          { title: "Dry Herb", text: "Specialist dry herb option for experienced CBD users.", meta: "1 product" },
          { title: "CBD Vape", text: "Hurb Breeze CBD prefilled pod kit and vape hardware paths.", meta: "2 devices" },
        ],
      },
      { title: "Stocked CBD Brands", list: ["Hemp Life, Just CBD, Professor Herb, and Hurb Breeze."] },
    ],
  },
  {
    slug: "deals",
    ...
    description:
      "Dedicated offer visibility gathering bundle deals, new arrivals, coming-soon products, and free shipping messaging.",
    ...
    sections: [
      {
        ...
        cards: [
          { title: "10ml Multipacks", text: "Promote value-led TPD-compliant multipacks with simple pricing.", meta: "Bundle deal" },
          { title: "New Flavours", text: "Use launch copy such as Just Launched and Limited Batch to create urgency.", meta: "New arrival" },
          { title: "Fan Favourites", text: "Surface high-repeat ranges and coming-soon products near the top of the page.", meta: "Repeat purchase" },
          { title: "Delivery Value", text: "Remind customers that Royal Mail Tracked 24 becomes free over £30.", meta: "Free over £30" },
        ],
      },
    ],
  },
  {
    ...
    description:
      "New flavour launches get urgency, text context, and fast routes into the right category.",
    ...
    sections: [
      {
        ...
        cards: [
          { title: "Cedar Reserve", text: "The largest house range, ideal for headline flavour launches and limited-batch callouts.", meta: "House favourite" },
          { title: "Brain Freeze", text: "Cooling fruit and menthol blends for customers searching for ice-heavy profiles.", meta: "Menthol specialist" },
          { title: "Bar Wars", text: "TPD-compliant 10ml flavours with prominent bundle merchandising.", meta: "4 for £11" },
          { title: "FiftyFifty Smooth", text: "Smooth nic salt style positioning for pod users and new vapers.", meta: "4 for £11" },
        ],
      },
    ],
  },
  {
    ...
    description: "A dedicated store finder experience for online, phone, and in-store support.",
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          { title: "Search by postcode", text: "Connects to store data and shows nearest branches.", meta: "Functional design" },
          { title: "Store services", text: "Advice, returns support, stock availability, and beginner guidance.", meta: "Retail support" },
          { title: "Map-ready layout", text: "Structured to accept an embedded map or store locator API.", meta: "Next step" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    description: "Orders placed before 2pm Monday to Friday dispatch the same day, excluding bank holidays.",
    cta: "See Returns",
    ctaHref: "/returns",
    stats: [
      ["£3.99", "Tracked 24"],
    ...
    sections: [
      {
        ...
        list: [
          ...
          "International shipping policy is stated clearly before launch.",
        ],
      },
    ],
  },
  {
    ...
    description: "Phoenix Vapers accepts returns for faulty products only. Products are tested before replacements are issued.",
    cta: "Contact Support",
    ctaHref: "/contact",
    stats: [
  ...
  },
  {
    ...
    description: "A clear visual explainer for earning, redeeming, and understanding how points affect free shipping.",
    cta: "View Deals",
    ctaHref: "/deals",
    stats: [
    ...
    sections: [
      {
        ...
        cards: [
          { title: "Spend £25", text: "Earn 25 points, equal to £0.25 future saving.", meta: "Every order counts" },
          { title: "Spend £50", text: "Earn 50 points, equal to £0.50 future saving.", meta: "No minimum wait" },
          { title: "Spend £100", text: "Earn 100 points, equal to £1 off a future order.", meta: "No earning cap" },
        ],
      },
      {
  ...
  },
  {
    ...
    description: "Covers nicotine strength, nic salts, shortfills, coils, delivery, and returns.",
    cta: "Contact Support",
    ctaHref: "/contact",
    faqs: [
      {
      ...
      },
      {
        ...
        answer: "No. Phoenix Vapers operates a fault-based returns policy and does not accept returns based on flavour preference.",
      },
    ],
  },
  {
    ...
    description: "A simple support hub for online orders, live chat, phone, email, and in-store escalation.",
    cta: "Find A Store",
    ...
    sections: [
      {
        ...
        cards: [
          { title: "Online Orders", text: "Email orders@phoenixeliquid.co.uk with your order number and issue.", meta: "Fastest route" },
          { title: "Phone Support", text: "Call 01733887900 during weekday business hours for customer service.", meta: "8am-4pm" },
          { title: "Live Chat", text: "Use live chat during business hours or leave an offline message.", meta: "Weekdays" },
          { title: "Store Complaints", text: "Email petertuck@phoenixeliquid.co.uk with date of visit and store location.", meta: "In-store help" },
        ],
      },
    ],
    form: true,
  },
  {
    ...
    description: "Safety, compliance, and trust marks are prominent throughout the frontend, not hidden only in the footer.",
    cta: "Read FAQ",
    ctaHref: "/faq",
    stats: [
      ["18+", "age restricted"],
